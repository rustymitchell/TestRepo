...
echo Success!
echo IP:
tasklist | find /i "ngrok.exe" >Nul && curl -s localhost:4040/api/tunnels | jq -r .tunnels[].public_url || echo "Failed to retreive NGROK authtoken - check again your authtoken"
